...
function mainBundleFixture() {
  return [
    ...
    "function eA(e,t,n){let r=n?.ownership,i=t.onReleased,a=r==null?t:{onPressed:()=>{r.isOwner()&&t.onPressed()},onReleased:i==null?void 0:()=>{r.isOwner()&&i()}};if(Rk(e))return Lk(e)?Mk(e,a,n?.bareModifierTrigger):null;let o=oA(e),s=()=>{a.onPressed()},l=c.globalShortcut.register(o,s);return l?process.platform===`darwin`?sA({hotkey:e,onPressed:s,registrationHotkey:o}):{handlesRelease:!1,unregister:()=>{c.globalShortcut.unregister(o)}}:null}",
