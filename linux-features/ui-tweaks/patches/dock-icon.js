...
const patchedUpdateGate =
  "I=()=>{if(!v&&process.platform!==`linux`)return;let e=A();F(e),rde({preference:e,resourceName:e===`codex-system`?N.light:null}).then(e=>{e&&F(A())})}";
...
const currentTrayRegistration =
  "i=new l.Tray(n.defaultIcon,process.platform===`win32`&&l.app.isPackaged?aMe(t):void 0);if(!W9)return";
const patchedTrayRegistration =
  "i=new l.Tray(process.platform===`linux`&&globalThis.codexLinuxDockIconImage&&!globalThis.codexLinuxDockIconImage.isEmpty()?globalThis.codexLinuxDockIconImage:n.defaultIcon,process.platform===`win32`&&l.app.isPackaged?aMe(t):void 0);if(!W9)return";
